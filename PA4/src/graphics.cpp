...
bool Graphics::Initialize(int width, int height)
{
  ...
  if(!m_shader->AddShader(GL_VERTEX_SHADER, "GL_VERTEX_SHADER.vert" ))
  {
  ...
  if(!m_shader->AddShader(GL_FRAGMENT_SHADER, "GL_FRAGMENT_SHADER.frag"))
  {
